...
This tutorial assumes that you have already gone through this :doc:`one <../file/delay_sum>`. This tutorial demonstrates
how to perform real-time sound source separation by outputting the enhanced dominant sound to the default audio output.
...
1. Configures the delay-and-sum pipeline and the sound cards.
