...
.. code-block:: python
    ...
    INPUT_PATH = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'audio', 'mix_sc16f_delay_sum.wav')
...
.. raw:: html
    ...
    <audio controls>
      <source src="_static/tutorials/delay_sum_before.wav" type="audio/wav">
...
.. raw:: html
    ...
    <audio controls>
      <source src="_static/tutorials/delay_sum_after.wav" type="audio/wav">
      Your browser does not support the <code>audio</code> element.
    </audio>
